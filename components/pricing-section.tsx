    ...
    <SectionContainer id="pricing" className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">Trusted by the best marketing teams</p>

          {/* Pricing Toggle */}
          <div className="flex justify-center items-center mb-12">
            <div className="bg-white/10 backdrop-blur-md rounded-full p-1 border border-white/20">
              <div className="flex">
                <button className="px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 bg-white/20 text-white">
                  Monthly
                </button>
                <button className="px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 text-white/70 hover:text-white">
                  Yearly
                  ...
                  <div className="flex items-baseline justify-center mb-4">
                    {tier.isCustom ? (
                      ...
                      <>
                        ...
                        <span className="text-white/60 ml-2">/user/month</span>
                      </>
                    )}
                  </div>
